...
myCodeImmersivesObj['I am exactly this cool'] = 'sooooooo cool';
...
mySelf.address.push('Georgia');
mySelf.address.push('Albany');
mySelf.address.push('Doublegate');
...
const myPlace = {
  population: 5,
  ordinary: false,
  array: ['Evan', 'Marissa', 'Christopher'],
  age: [20, 16, 9,]
  love; ['bass', 'cello', 'violin'],
}
...
strings.instrument = 'Cello';
strings.symphony['Albany Symphony Orchestra'];
